...
NSString *BKiCloudContainerIdentifier = @"iCloud.org.shengye.blinkshell";
...
//  CKDatabase *database = [[CKContainer containerWithIdentifier:@"iCloud.org.shengye.blinkshell"]privateCloudDatabase];
